...
/**
 * Ensure Privacy + Cookies pages exist with stable English slugs for Next.js routes.
 */
function aria_ensure_legal_pages(): void
{
	$pages = [
		[
			'slug'    => 'privacy',
			...
			'content' => <<<'HTML'
<p><em>Πρότυπο κείμενο — προσαρμόστε το με τον νομικό σας σύμβουλο πριν τη τελική χρήση.</em></p>
<h2>1. Εισαγωγή</h2>
<p>Η παρούσα Πολιτική Απορρήτου περιγράφει πώς η Άρια Τσιάκα («εμείς») συλλέγει και χρησιμοποιεί πληροφορίες όταν επισκέπτεστε τον ιστότοπο <strong>ariatsiaka.gr</strong> ή επικοινωνείτε μαζί μας.</p>
<h2>2. Τι δεδομένα συλλέγουμε</h2>
<ul>
<li>Στοιχεία επικοινωνίας που μας παρέχετε εσείς (π.χ. όνομα, τηλέφωνο, email) όταν ζητάτε ραντεβού ή πληροφορίες.</li>
<li>Τεχνικά δεδομένα χρήσης ιστότοπου σε περιορισμένο βαθμό (π.χ. διεύθυνση IP, τύπος προγράμματος περιήγησης), όπου εφαρμόζεται.</li>
</ul>
<h2>3. Πώς χρησιμοποιούμε τα δεδομένα</h2>
<p>Χρησιμοποιούμε τα δεδομένα για να απαντήσουμε σε αιτήματα, να προγραμματίσουμε ραντεβού και να βελτιώσουμε τον ιστότοπο. Δεν πουλάμε προσωπικά δεδομένα σε τρίτους.</p>
<h2>4. Νομική βάση</h2>
<p>Η επεξεργασία βασίζεται στη συγκατάθεσή σας και/ή στην ανάγκη να απαντήσουμε σε αίτημά σας πριν από σύμβαση υπηρεσιών.</p>
<h2>5. Διατήρηση</h2>
<p>Διατηρούμε τα δεδομένα μόνο για όσο χρειάζεται για τον σκοπό για τον οποίο συλλέχθηκαν ή όπως απαιτεί ο νόμος.</p>
<h2>6. Τα δικαιώματά σας</h2>
<p>Μπορείτε να ζητήσετε πρόσβαση, διόρθωση ή διαγραφή των δεδομένων σας επικοινωνώντας μαζί μας μέσω της σελίδας Επικοινωνία.</p>
<h2>7. Επικοινωνία</h2>
<p>Για θέματα απορρήτου, χρησιμοποιήστε τα στοιχεία στη σελίδα <a href="/contact">Επικοινωνία</a>.</p>
HTML
		],
		[
			'slug'    => 'cookies',
...
<p>Τα cookies είναι μικρά αρχεία που αποθηκεύονται στη συσκευή σας όταν επισκέπτεστε έναν ιστότοπο. Βοηθούν στη λειτουργία, την ασφάλεια και (όπου εφαρμόζεται) την ανάλυση επισκεψιμότητας.</p>
<h2>2. Ποια cookies χρησιμοποιούμε</h2>
<ul>
<li><strong>Απαραίτητα:</strong> για βασική λειτουργία και ασφάλεια του ιστότοπου.</li>
<li><strong>Προτίμησης / τεχνικά:</strong> όπου χρειάζεται για σωστή εμφάνιση περιεχομένου.</li>
<li><strong>Ανάλυσης:</strong> μόνο αν ενεργοποιηθούν στο μέλλον και με σχετική ενημέρωση.</li>
</ul>
<h2>3. Διαχείριση cookies</h2>
<p>Μπορείτε να διαγράψετε ή να αποκλείσετε cookies από τις ρυθμίσεις του προγράμματος περιήγησής σας. Ορισμένες λειτουργίες του ιστότοπου μπορεί να επηρεαστούν.</p>
<h2>4. Περισσότερες πληροφορίες</h2>
<p>Για προσωπικά δεδομένα δείτε την <a href="/privacy">Πολιτική Απορρήτου</a>. Ερωτήσεις μέσω της σελίδας <a href="/contact">Επικοινωνία</a>.</p>
HTML
		],
	];
